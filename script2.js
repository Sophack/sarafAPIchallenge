...
var _options = document.querySelector('.quiz-options');
var _checkBtn = document.getElementById('check-answer');
var _playAgainBtn = document.getElementById('play-again');
